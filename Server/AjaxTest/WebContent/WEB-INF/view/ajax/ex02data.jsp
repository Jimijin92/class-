...
<script>
	...
	$(top.document).find("#item1").css("width", "${dto.cnt1*20}px");
	$(top.document).find("#item2").css("width", "${dto.cnt2*20}px");
	$(top.document).find("#item3").css("width", "${dto.cnt3*20}px");
	$(top.document).find("#item4").css("width", "${dto.cnt4*20}px");
...
<body>
	<!-- "WebContent/WEB-INF/view/ajax/ex02.jsp" -->
