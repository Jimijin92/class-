...
<body>
	<!-- "WebContent/WEB-INF/view/ajax/idcheck.jsp" -->
	<div class="container">
		<div class="panel panel-default">
			...
			<div class = "panel-body">
				<form method="POST" action="/ajax/idcheck.do">
					...
					<input type="submit" value="검사하기" class="btn btn-info"/>
				</form>
				...
				<c:if test="${!empty result && result == 0 }">
					...
					<input type="button" value="사용하기" class="btn btn-info" onclick="use();"/>
				</c:if>
			</div>
		</div>
