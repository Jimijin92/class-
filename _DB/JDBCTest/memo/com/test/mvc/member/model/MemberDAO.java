...
public class MemberDAO {
	...
	public MemberDAO() {
		try {
			...
			System.out.println("MemberDAO.Contructor : " + e.toString());
		}
	}
	...
	public int add(MemberDTO dto) {
		...
		try {
			PreparedStatement stat
				= conn.prepareStatement(ds.get("member.add"));
	...
	//Auth가 이메일과 비밀번호를 줄테니 인증 처리를 해다오..
	...
	public String getMseq(MemberDTO dto) {
		try {
			...
			PreparedStatement stat 
				= conn.prepareStatement(ds.get("member.getMseq"));
			...
			System.out.println("MemberDAO.getMesq : " + e.toString());
		}
		return null;
	}
	...
	public int del(String mseq) {
		try {
			PreparedStatement stat 
				= conn.prepareStatement(ds.get("member.del"));
