...
-- NN 제약이 걸린 컬럼을 새로 추가하는 경우
ALTER TABLE tbledit
      ADD (color VARCHAR2(30) DEFAULT '미정' NOT NULL); -- 모든 기존 레코드의 새컬럼에 default가 적용된다.
...
ALTER TABLE tbledit
      MODIFY (price NUMBER(4) NOT NULL ); -- 주의 : 기존 값들이 전부 있다고 가정
...
3. TRUNCATE 명령어(수학 함수 TURC 함수와 다른 명령어)
- 정식(***)
