...
GRANT CREATE TABLE TO team; -- 권한 2개
...
3. DROP ANY TABLE : 보통 테이블의 삭제권한은 본인이 가진다. (혹은 DROP ANY TABLE 권한을 가진 관리자급)
...
5. CREATE PROCCEDURE : 프로시저 생성 권한
...
-- : GRANT OBJECT_PRIVILEAGE ON 대상객체 TO 유저명
...
--권한 뺏기 
-- : REVOKE OBJECT_PRIVILEAGE ON 대상객체 TO 유저명;
REVOKE SELECT
        ON hr.tblinsa
                FROM team;
