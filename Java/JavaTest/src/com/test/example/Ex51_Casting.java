...
public class Ex51_Casting {
	...
	public static void main(String[] args) {
		...
		//2. 프린터 브랜드 증가 -> Dell400, BenQ500, Epson100 ..... 10종류
...
//		p2 = hp;
		...
		for (int i = 0; i<ps.length; i++) {
			...
			//System.out.println(ps[i] instanceof LG200);//return값 boolean
...
//프린터로서 갖춰야할 공통적인 부분을 구현하기 위해 부모클래스 선언
//	- 일반 공통 구현부 + 행동 제어
...
class HP300 extends Printer{
	...
	public void print() {
		//HP만의 독자 기술 사용 -> 출력
		System.out.println("HP200으로 레이처 출력을 합니다.");
	}
