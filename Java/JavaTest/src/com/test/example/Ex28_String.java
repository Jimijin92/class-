...
public class Ex28_String {
	...
	private static void m3() {
		...
		//모든 참조형 -> 생성
		String s2 = new String("홍길동");//FM방식이나 편의를 위해 String s1 = "홍길동"; 가능함
	...
	private static void m2() {
		...
		String s1 = "안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요안녕하세요"
	...
	private static void m1() {
		...
		String b = "홍길동";
		String d = "안녕하세요. 반갑습니다. 하하하하 호호호호 후후후";
		...
		System.out.println(s1 == s2);//잘못된 표기방식
		System.out.println(s1 == s3);//잘못된 표기방식
